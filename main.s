...
CT			RN		R0 ; CT: C�mara T�rmica 
CD			RN		R1 ; CD: C�mara de Distancia	
AS			RN		R2 ; AS: Alarmas provenientes del Server
MS			RN		R3 ; MS: Mensaje del Server que se imprimir� en el LCD

	
; Se asignan etiquetas para los espacios de memoria RAM donde se almacenar�n los ouputs del sistema
...
EMC1		EQU		0x2000000C  ; Etiqueta del espacio de memoria para el Enable Multiple Connections TCP del M�dulo Wifi Parte 1
EMC2		EQU		0x20000010  ; Etiqueta del espacio de memoria para el Enable Multiple Connections TCP del M�dulo Wifi Parte 2
EMC3		EQU		0x20000014  ; Etiqueta del espacio de memoria para el Enable Multiple Connections TCP del M�dulo Wifi Parte 3
EMC4		EQU		0x20000018  ; Etiqueta del espacio de memoria para el Enable Multiple Connections TCP del M�dulo Wifi Parte 4
EMC5		EQU		0x2000001C  ; Etiqueta del espacio de memoria para el Enable Multiple Connections TCP del M�dulo Wifi Parte 5
EMC6		EQU		0x20000020  ; Etiqueta del espacio de memoria para el Enable Multiple Connections TCP del M�dulo Wifi Parte 6
TCPS1		EQU		0x20000024  ; Etiqueta del espacio de memoria para el TCP Start del M�dulo Wifi Parte 1
TCPS2		EQU		0x20000028  ; Etiqueta del espacio de memoria para el TCP Start del M�dulo Wifi Parte 2
TCPS3		EQU		0x2000002C  ; Etiqueta del espacio de memoria para el TCP Start del M�dulo Wifi Parte 3
TCPS4		EQU		0x20000030  ; Etiqueta del espacio de memoria para el TCP Start del M�dulo Wifi Parte 4
TCPS5		EQU		0x20000034  ; Etiqueta del espacio de memoria para el TCP Start del M�dulo Wifi Parte 5
TCPS6		EQU		0x20000038  ; Etiqueta del espacio de memoria para el TCP Start del M�dulo Wifi Parte 6
TCPS7		EQU		0x2000003C  ; Etiqueta del espacio de memoria para el TCP Start del M�dulo Wifi Parte 7	
TCP			EQU		0x20000040  ; Etiqueta del espacio de memoria para el valor de activaci�n de TCP	
...
PTCP		EQU		0x2000005C	; Etiqueta del espacio de memoria para el puerto TCP de comunicaci�n con el m�dulo de Wifi	
EDMW1		EQU		0x20000060  ; Etiqueta del espacio de memoria para el comando de Enviar Datos por medio del M�dulo de Wifi Parte 1
EDMW2		EQU		0x20000064  ; Etiqueta del espacio de memoria para el comando de Enviar Datos por medio del M�dulo de Wifi Parte 2
EDMW3		EQU		0x20000068  ; Etiqueta del espacio de memoria para el comando de Enviar Datos por medio del M�dulo de Wifi Parte 3
EDMW4		EQU		0x2000006C  ; Etiqueta del espacio de memoria para el comando de Enviar Datos por medio del M�dulo de Wifi Parte 4
EDMW5		EQU		0x20000070  ; Etiqueta del espacio de memoria para el comando de Enviar Datos por medio del M�dulo de Wifi Parte 5
EDMW6		EQU		0x20000074  ; Etiqueta del espacio de memoria para el comando de Enviar Datos por medio del M�dulo de Wifi Parte 6
EDMW7		EQU		0x20000078  ; Etiqueta del espacio de memoria para el comando de Enviar Datos por medio del M�dulo de Wifi Parte 7
URL1		EQU		0x2000007C  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 1
URL2		EQU		0x20000080  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 2
URL3		EQU		0x20000084  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 3
URL4		EQU		0x20000088  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 4
URL5		EQU		0x2000008C  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 5
URL6		EQU		0x20000090  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 6
URL7		EQU		0x20000094  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 7
URL8		EQU		0x20000098  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 8
URL9		EQU		0x2000009C  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 9
URL10		EQU		0x200000A0  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 10
URL11		EQU		0x200000A4  ; Etiqueta del espacio de memoria para la URL de comunicaci�n Parte 11
G4BS		EQU		0x200000A8	; Etiqueta del espacio de memoria que representa el GET de 4 Bytes que se obtienen a trav�s de la comunicaci�n serial
DCT			EQU		0x200000AC  ; Etiqueta del espacio de memoria que indica el inicio donde se almacenan los datos de la c�mara t�rmica
DCDD		EQU		0x200002A0	; Etiqueta del espacio de memoria que indica el inicio donde se almacenan los datos de la c�mara de distancia
P4BS		EQU		0x20000494	; Etiqueta del espacio de memoria que representa el POST de 4 Bytes que se mandan a trav�s de la comunicaci�n serial
...
SMW		MOV R6,#2
		...
		; Se alamcena un valor simb�lico en el espacio de memoria donde se obtendr�an los 4 bytes al hacer un GET al Server del sistema
		MOV R7,0x0000FFFF
		LDR R8,=G4BS
		STR R7,[R8]
		...
		MOV R6,#2
DL2		CBZ	R6,SMW2  ; B�sicamente lo saca del loop cuando R6(contador del delay en este caso) sea cero
		SUB R6,R6,#1
		B	DL2      ; Ciclo DL2 = Delay de 2 tiempos
				
		
		; Establecer conexiones m�ltiples TCP en el m�dulo  Wifi, con el comando AT: AT+CIPMUX=1 = 0x41542B4349504D55583D31
SMW2 	MOV R7, 0x4154
		LDR R8,=EMC1
		STR R7,[R8]
		MOV R7,0x2B43
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL1		CBZ	R7,SMW3  ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
		B	DL1      ; Ciclo DL1 = Primer Delay de 1 tiempo
		
		; Se establece una conexi�n TCP cliente al servidor del sistema, dando como p�rametros el IP del Server y el puerto de comunicaci�n
...
SMW3   	MOV R7, 0x4154
		...
		; Se establece el valor de TCP en 1 para indicar el tipo de conexi�n
		MOV R7, #1
		LDR R8,=TCP
		STR R7,[R8]
		...
		; Se define el puerto de comunicaci�n EN 8080
		MOV R7, #8080
		LDR R8,=PTCP
		STR R7,[R8]
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL12	CBZ	R7,SMW4  ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
		B	DL12     ; Ciclo DL12 = Segundo Delay de 1 tiempo
		
		; Establecer el comando AT para poder enviar datos atrav�s del m�dulo de wifi
...
; Subrutina que se encarga de hacer el request GET de los datos de la c�mara t�rmica y de la c�mara de distancia
		...
		; Establecer la URL de Env�o, que en este caso corresponde con la Operaci�n GET, para obtener los datos de la c�mara t�rmica
...
GDC		MOV R7, 0x4745
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL13	CBZ	R7,GDC2  ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
		B	DL13     ; Ciclo DL13 = Tercer Delay de 1 tiempo
		
		
		
		; Ciclo que realiza el GET de los datos de la c�mara t�rmica
GDC2	MOV R6,#0     ; Se establece el contador en 0
		LDR R7,=G4BS  ; Se carga en R7 la direcci�n de memoria donde se obtienen los datos del GET
GDC3	CMP R6,#500   ; El valor real es 153600, para efectos de prueba se deja en 500
		BEQ	GDC4
		LDRNE CT,[R7] ; Se almacena el contenido de la direcci�n guardada en R7 en el registro de la c�mara t�rmica
		LDRNE R8,=DCT ; Se almacena en R8 la direcci�n de memoria donde se almacenan los datos de la c�mara t�rmica
		
		; Para guardar los datos de la c�mara se usa como base el valor inicial de R8 y se le suma el offset correspondiente al valor actual del contador
		STRNE CT,[R8,R6] ; Se guarda lo que hay en el registro de la c�mara t�rmica en la direcci�n de memoria correspondiente
		ADDNE R6,R6,#4   ; Se incrementa el contador en 4, que es el tama�o de los bloques de memoria (4 bytes)
		BNE GDC3
	
	
		; Establecer la URL de Env�o, que en este caso corresponde con la Operaci�n GET, para obtener los datos de la c�mara de distancia
...
GDC4	MOV R7, 0x4745
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL14	CBZ	R7,GDC5  ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
		B	DL14     ; Ciclo DL14 = Cuarto Delay de 1 tiempo
		
		
		; Ciclo que realiza el GET de los datos de la c�mara de distancia
		; Se almacena otro valor simb�lico en el espacio de memoria donde se obtendr�an los 4 bytes al hacer un GET al Server del sistema. Esto para revisar en memoria y simular el env�o de datos distintos
...
GDC6	CMP R6,#500  ; El valor real es 4147200, para efectos de prueba se deja en 500
		BEQ	GDC7
		LDRNE CD,[R7]  ; Se almacena el contenido de la direcci�n guardada en R7 en el registro de la c�mara de distancia
		LDRNE R8,=DCDD ; Se almacena en R8 la direcci�n de memoria donde se almacenan los datos de la c�mara de distancia
		
		; Para guardar los datos de la c�mara se usa como base el valor inicial de R8 y se le suma el offset correspondiente al valor actual del contador
		STRNE CD,[R8,R6] ; Se guarda lo que hay en el registro de la c�mara de distancia en la direcci�n de memoria correspondiente
		ADDNE R6,R6,#4   ; Se incrementa el contador en 4, que es el tama�o de los bloques de memoria (4 bytes)
		BNE GDC6
...
; Subrutina que se encarga de hacer el request POST de los datos obtenidos de las c�maras al Server del sistema
		...
		; Establecer la URL de Env�o, que en este caso corresponde con la Operaci�n POST, para mandar los datos de la c�mara t�rmica
...
PDS		MOV R7, 0x504F
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL15	CBZ	R7,PDS2 ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
		B	DL15    ; Ciclo DL15 = Quinto Delay de 1 tiempo
		
		; Ciclo que realiza el POST de los datos de la c�mara t�rmica
PDS2	MOV R6,#0    ; Se establece el contador en 0
		LDR R7,=P4BS ; Se carga en R7 la direcci�n de memoria donde se guardan los datos que ser�n enviados mediante la instrucci�n POST
		LDR R8,=DCT  ; Se carga en R8 la direcci�n de memoria donde comienzan los datos de la c�mara t�rmica
PDS3	CMP R6,#500  ; El valor real es 153600, para efectos de prueba se deja en 500
		...
		; Establecer la URL de Env�o, que en este caso corresponde con la Operaci�n POST, para mandar los datos de la c�mara de distancia
...
PDS4	MOV R7, 0x504F
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL16	CBZ	R7,PDS5 ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
		B	DL16    ; Ciclo DL16 = Sexto Delay de 1 tiempo

		
		; Ciclo que realiza el POST de los datos de la c�mara de distancia
PDS5	MOV R6,#0    ; Se establece el contador en 0
		LDR R7,=P4BS ; Se carga en R7 la direcci�n de memoria donde se guardan los datos que ser�n enviados mediante la instrucci�n POST
		LDR R8,=DCDD ; Se carga en R8 la direcci�n de memoria donde comienzan los datos de la c�mara de distancia
...
; Subrutina que se encarga de hacer el request GET al Server del Mensaje de que se proyectar� en el LCD y del c�digo de activaci�n de las alarmas
		...
		; Establecer la URL de Env�o, que en este caso corresponde con la Operaci�n GET, para obtener los datos del mensaje del server
...
GMA		MOV R7, 0x4745
		...
		; Se alamcena otro valor simb�lico en el espacio de memoria donde se obtendr�an los 4 bytes al hacer un GET al Server del sistema, para efectos de pruebas
		MOV R7,0x0000AAAA
		LDR R8,=G4BS
		STR R7,[R8]
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL17	CBZ	R7,GMA2 ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
		B	DL17    ; Ciclo DL17 = S�ptimo Delay de 1 tiempo
...
GMA3	CMP R6,#44   ; Se deben llenar 11 bloques de memoria con 4 bytes cada uno, para obtener el mensaje completo del server 
		BEQ	GMA4
		LDRNE MS,[R7] ; Se almacena el contenido de la direcci�n guardada en R7 en el registro del mensaje del server
		LDRNE R8,=DMS ; Se almacena en R8 la direcci�n de memoria donde se almacenan los datos del mensaje del server
		...
		STRNE MS,[R8,R6] ; Se guarda lo que hay en el registro del mensaje del server en la direcci�n de memoria correspondiente
		ADDNE R6,R6,#4   ; Se incrementa el contador en 4, que es el tama�o de los bloques de memoria (4 bytes)
		BNE GMA3
		
		; Establecer la URL de Env�o, que en este caso corresponde con la Operaci�n GET, para el valor de las alarmas enviado por el server
...
GMA4	MOV R7, 0x4745
		...
		; Se hace un delay de 1 milisegundo (En este caso se espera 1 tiempo simb�lico)
		MOV R7,#1
DL18	CBZ	R7,GMA5 ; B�sicamente lo saca del loop cuando R7(contador del delay en este caso) sea cero
		SUB R7,R7,#1
...
GMA5	LDR R7,=G4BS ; Se carga en R7 la direcci�n de memoria donde se obtienen los datos del GET
		LDR	R8,=DAS	 ; Se almacena en R8 la direcci�n de memoria donde se almacenan los datos del activador de las alarmas
		LDR	AS,[R7]
		STR	AS,[R8]
		BX	LR ; Se regresa al flujo principal del programa
